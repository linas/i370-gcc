  ...
  "*
{
  ...
  mvs_check_page (0, 6, 8);
  /* should never get here ... let it break. */
  return \"xxxMVC	%O0(8,%R0),%1\";
}"
   [(set_attr "length" "8")]
)
...
(define_insn ""
  [(set (match_operand:HI 0 "r_or_s_operand" "=R")
        (match_operand:HI 1 "r_or_s_operand" "R"))]
  "TARGET_CHAR_INSTRUCTIONS"
  "*
{
  check_label_emit ();
...
(define_insn ""
  [(set (match_operand:QI 0 "r_or_s_operand" "=R")
	(match_operand:QI 1 "r_or_s_operand" "R"))]
  "TARGET_CHAR_INSTRUCTIONS"
  "*
{
  check_label_emit ();
